...
#line 51 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
...
layout(location = 1) in(float2) In_texCoordLmap;
layout(location = 2) in(float) In_viewLightmaps;
#line 12
...
//float4 PS_MAIN( VSOutput In )
{
	...
	In.texCoordLmap = In_texCoordLmap;
	In.viewLightmaps = In_viewLightmaps;
#line 15
//    INIT_MAIN;
    ...
    {
    	out_float4 = fragmentColor;
    	return;
    }
#line 20
//    RETURN(fragmentColor);
}
#line 52 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
