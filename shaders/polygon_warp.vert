...
#line 59 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
#line 1 "D:/Documents/tfQuake2/tf/shaders/polygon_warp.vert.fsl"
STRUCT(VSInput)
{
...
{
#define _GetvpMatrix PushConstant.vpMatrix
#line 9
...
layout(location = 0) out(float2) out_VSOutput_texCoord;
layout(location = 1) out(float4) out_VSOutput_color;
layout(location = 2) out(float) out_VSOutput_aTreshold;
#line 27
...
//    INIT_MAIN;
...

    {
    	...
    	out_VSOutput_aTreshold = out_VSOutput.aTreshold;
    	return;
    }
#line 39
//    RETURN(Out);
}
#line 60 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
