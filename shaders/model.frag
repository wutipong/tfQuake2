...
#line 27 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
#line 1 "D:/Documents/tfQuake2/tf/shaders/model.frag.fsl"
...
//float4 PS_MAIN( VSOutput In )
{
	...
	In.color = In_color;
	In.textured = In_textured;
#line 14
//    INIT_MAIN;
    if(In.textured > 0)
        {
        	out_float4 = SampleTex2D(Get(sTexture), Get(textureSampler), In.texCoord) * clamp(In.color, 0.0, 1.0);
        	return;
        }
#line 16
...
#line 28 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
