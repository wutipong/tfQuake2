...
#line 55 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
#line 1 "D:/Documents/tfQuake2/tf/shaders/polygon_lmap.vert.fsl"
STRUCT(VSInput)
{
...
layout(location = 2) in(float2) TEXCOORD1;
#line 7
...
#define _GetviewLightmaps viewLightmaps
#line 16
...
layout(location = 1) out(float2) out_VSOutput_texCoordLmap;
layout(location = 2) out(float) out_VSOutput_viewLightmaps;
#line 26
...
//    INIT_MAIN;
...

    {
    	...
    	out_VSOutput_texCoordLmap = out_VSOutput.texCoordLmap;
    	out_VSOutput_viewLightmaps = out_VSOutput.viewLightmaps;
    	return;
    }
#line 37
//    RETURN(Out);
}
#line 56 "D:/Documents/tfQuake2/tf/shaders/ShaderList.fsl"
