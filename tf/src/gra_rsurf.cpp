...
void Vk_BeginBuildingLightmaps(model_t *m)
{
    ...
    */
    ...
    // 		QVk_CreateTexture(&vk_state.lightmap_textures[i], (unsigned char*)dummy, BLOCK_WIDTH, BLOCK_HEIGHT,
    // vk_current_lmap_sampler); 		QVk_DebugSetObjectName((uint64_t)vk_state.lightmap_textures[i].image,
    // VK_OBJECT_TYPE_IMAGE, va("Image: dynamic lightmap #%d", i));
    // 		QVk_DebugSetObjectName((uint64_t)vk_state.lightmap_textures[i].imageView, VK_OBJECT_TYPE_IMAGE_VIEW,
    // va("Image View: dynamic lightmap #%d", i));
    // 		QVk_DebugSetObjectName((uint64_t)vk_state.lightmap_textures[i].descriptorSet, VK_OBJECT_TYPE_DESCRIPTOR_SET,
    // va("Descriptor Set: dynamic lightmap #%d", i));
    // 		QVk_DebugSetObjectName((uint64_t)vk_state.lightmap_textures[i].allocInfo.deviceMemory,
